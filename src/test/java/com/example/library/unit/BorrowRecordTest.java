...
class BorrowRecordTest {
    ...
    class IsOverdueTests {
        ...
        void shouldBeOverdue_WhenPastDueDateAndStillBorrowed() {
            ...
            boolean result = record.isOverdue(record.getDueDate().plusDays(1));
        ...
        void shouldNotBeOverdue_WhenBeforeDueDate() {
            ...
            boolean result = record.isOverdue(record.getDueDate().minusDays(1));
        ...
        void shouldNotBeOverdue_WhenAlreadyReturned() {
            ...
            boolean result = record.isOverdue(record.getDueDate().plusDays(3));
        ...
        void shouldNotBeOverdue_OnExactDueDate() {
            ...
            boolean result = record.isOverdue(record.getDueDate());
